...
Zuletzt sollen die Korngrößen mithilfe der Scherrer-Gleichung abgeschätzt werden. Mit Gleichung \ref{eqn:scherrer_korngroesse} wird die Korngröße aus FWHM und den Energien der K$_{\alpha}$-Linien bestimmt. Auf eine Fehlerrechung wird aufgrund der geringen Genauigkeit des Scherrer-Formfaktors verzichtet.
\begin{table}[H]
\caption{Auswertung der K$_{\alpha_1}$ Linie}
\centering
...
\end{tabular} 
\end{table}
Die Korngrößen können in der Größenordnung von 38\AA{} bis 82\AA{} abgeschätzt werden. 
