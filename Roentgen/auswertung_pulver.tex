...
Die Lage der Maxima kann in Tabelle
\begin{tabular}{|c|c|c|c|c|c|c|c|}
\hline 2$\theta/^{\circ}$ K$_{\alpha_1}$ & 2$\theta/^{\circ}$ K$_{\alpha_2}$ & Vorgegebenes Pulver K$_{\alpha_1}$ & Vorgegebenes Pulver K$_{\alpha_2}$ & Simulation Silicium K$_{\alpha_1}$ & Simulation Silicium K$_{\alpha_2}$ & Simulation Germanium K$_{\alpha_1}$ & Simulation Germanium K$_{\alpha_2}$ \\ 
\hline  &  &  &  &  &  &  &  \\ 
\hline  &  &  &  &  &  &  &  \\ 
\hline  &  &  &  &  &  &  &  \\ 
\hline  &  &  &  &  &  &  &  \\ 
