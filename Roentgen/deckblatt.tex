...
\HRule \\[0.4cm]
{ \huge \bfseries Strukturanalyse mit Röntgenstrahlung}\\[0.4cm]				%Titel
...
\hline \textbf{Abstract: } \\
	   In diesem Versuch wird mittels Röntgenspektroskopie die Struktur verschiedener Materialien \\
	   untersucht \\
\hline 
\end{tabular}
\end{table} 
