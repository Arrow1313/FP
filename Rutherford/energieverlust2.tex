...
Die Bragg-Kurve ist in Abb. \ref{fig:braggkurve} für das $\alpha$-Strahlung in Luft dargestellt. Das Maximum der Bragg-Kurve ist näherungsweise gleichzusetzen mit der Reichweite des Teilchens, da der Energieverlust kurz danach auf Null absinkt.
...
\begin{figure}[H]
  ...
  \includegraphics[scale=0.5]{Braggkurve.png}
	\caption{Braggkurve für $\alpha$-Strahlung in Luft}
