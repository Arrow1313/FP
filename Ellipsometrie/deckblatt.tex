...
Ziel des Versuches ist die Bestimmung der komplexen Brechungsindex $ n = n' + i\kappa$ für \\ sechs verschieden Materialien. Für die Bestimmung wird die R$_p$/R$_s$-Methode verwendet.\\ 
\hline 
\end{tabular}
\end{table} 
