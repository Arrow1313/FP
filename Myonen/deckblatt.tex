...
\includegraphics[width=0.75\textwidth, height = 0.19\textwidth]{logo.png}\\[1cm]    	%Logo 
...
\HRule \\[0.4cm]
{ \huge \bfseries Lebensdauer von Myonen der Höhenstrahlung}\\[0.4cm]				%Titel
...
\hline \textbf{Abstract: } \\
	   ...
	   und möglicht geringem systematischen Fehler zu bestimmen\\
\hline 
\end{tabular}
\end{table} 
