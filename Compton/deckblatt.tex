...
\HRule \\[0.4cm]
{ \huge \bfseries Compton-Steuung}\\[0.4cm]				%Titel
...
In diesem Versuch soll der differentielle Wirkungsquerschnitt der Compton-Streuung\\ bis auch eine Ungenauigkeit von 10 \% bestimmt werden\\
\hline 
\end{tabular}
\end{table} 
