...
\caption{Fit der vorderen Peaks für $^{241}$Am. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_1} eingetragen.}
\label{fig:kilb_fit_1}
\end{figure}

\begin{table}[H]
\centering
\caption{Fitparameter für die vorderen Peaks der $^{241}$Am Quelle. Das $\chi^2_{red}$ ergab sich mit 1,15}
\label{tab:kalib_fit_1}
\begin{tabular}{|c|c|c|}
\hline Gaußpeak & Parameter & Wert \\ 
...
\caption{Fit des Hauptpeaks für $^{241}$Am. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_2} eingetragen. Das $\chi^2_{red}$ ergab sich mit 1,67}
\label{fig:kalib_fit_2}
\end{figure}

\begin{table}[H]
\centering
\caption{Fitparameter für die vorderen Peaks der $^{241}$Am Quelle.}
...
\caption{Fit des ersten Peaks für $^{133}$Ba. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_3} eingetragen.}
\label{fig:kilb_fit_3}
\end{figure}

\begin{table}[H]
\centering
\caption{Fitparameter für die vorderen Peaks der $^{133}$Ba Quelle. Das $\chi^2_{red}$ ergab sich mit 1,14}
...
\caption{Fit des zweiten Peaks für $^{133}$Ba. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_4} eingetragen.}
\label{fig:kilb_fit_4}
\end{figure}

\begin{table}[H]
\centering
\caption{Fitparameter für den zweiten Peak der $^{133}$Ba Quelle. Das $\chi^2_{red}$ ergab sich mit 2.31}
...
\caption{Fit des dritten Peaks für $^{133}$Ba. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_5} eingetragen.}
\label{fig:kilb_fit_5}
\end{figure}

\begin{table}[H]
\centering
\caption{Fitparameter für die dritten Peaks der $^{133}$Ba Quelle. Das $\chi^2_{red}$ ergab sich mit 1.77}
...
\caption{Fit des vierten Peaks für $^{133}$Ba. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_6} eingetragen.}
...
\caption{Fit des ersten Peaks für $^{137}$Cs. Die Fitparameter sind in Tabelle \ref{tab:kalib_fit_7} eingetragen.}
...
In diesem Abschnitt werden die Plots und Fits der Energiemessungen für die Winkel von \SI{20}{\degree} bis \SI{80}{\degree} mit den zugehörigen Fitparametern dargestellt.
\label{Anh:WQ}
\begin{figure}[H]
\centering
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{20}{\degree}. Das $\chi^2_{red}$ ergab sich mit 0,937}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{30}{\degree}. Das $\chi^2_{red}$ ergab sich mit 1.086}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{40}{\degree}. Das $\chi^2_{red}$ ergab sich mit 0.994}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{50}{\degree}. Das $\chi^2_{red}$ ergab sich mit 0.971}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{60}{\degree}. Das $\chi^2_{red}$ ergab sich mit 1.062}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{70}{\degree}. Das $\chi^2_{red}$ ergab sich mit 0.934}
...
\begin{table}[H]
\centering
\caption{Fitparameter für die Energiemessung bei \SI{80}{\degree}. Das $\chi^2_{red}$ ergab sich mit 1.019}
