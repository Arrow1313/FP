...
Mithilfe eines Rastertunnelmikroskops wird die Struktur verschiedener Materialien analysiert,\\ indem deren Oberfläche in verschiedenen Modi abgefahren wird.\\
\hline 
\end{tabular}
\end{table} 
